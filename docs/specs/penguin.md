...
- **오렌지 미니 부리**: `0xF4952E/0xC76F15` taperedTube (radii 0.17→0.045·crownH,
  scaleY 0.85), 폴리라인 (0, 0.02, 0.12) → (0, −0.02, −0.17) → (0, −0.16, −0.28)·L —
  ...
  앵커가 셸 표면보다 ~0.09rz 안쪽이므로 전방 돌출 0.28L + 팁 y −0.16L 확보
  (0.17L은 셸에 파묻혀 단추, 0.24L·팁 −0.11L도 정면에서 폼폼 볼로 읽힌 사고 이력 —
  정면 실루엣에서 팁이 밑동 하단 아래로 내려와야 부리로 판독). hitMeshes 등록.
