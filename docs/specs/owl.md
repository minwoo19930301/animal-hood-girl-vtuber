...
| 항목 | 실제 값 |
|---|---|
| 헤어 | 코코아 틴트 base `#5A3826` / shade `#2B1A14` / accent `#A36D47`. 컷 없음(롱 유지). |
...
| 셸 눈×2 | 플라밍고 눈판 기법, `surfacePoint(±0.54, 0.30)` 검증 좌표. Re=0.15·crownH(플라밍고보다 크고 동그랗게). 앰버 링 `#F0B429/#C98C14` 1.5Re + 검정 동공 `#221A29` 1.02Re + 흰 하이라이트 대(0.36Re)·소(0.15Re) |
